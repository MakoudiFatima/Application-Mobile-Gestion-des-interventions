...
public class InterventionsFaitActivity extends AppCompatActivity {
    ...
    private void setupAdapter() {
        ...
        listView = findViewById(R.id.interventionfaitlist);
        adapter = new InterventionsAdapter(InterventionsFaitActivity.this, listView, R.layout.listview_interventionsfait_adapter, db.getInterventionFait());
    ...
    private void setupCustomDialog() {
        ...
        AlertDialogsHelper.getAddInterventionDialog(InterventionsFaitActivity.this, alertLayout, adapter);
    }
}
