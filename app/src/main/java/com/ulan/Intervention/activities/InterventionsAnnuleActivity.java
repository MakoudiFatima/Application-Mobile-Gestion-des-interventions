...
public class InterventionsAnnuleActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interventionsannule);
        initAll();
    }
    ...
    private void setupAdapter() {
        ...
        listView = findViewById(R.id.interventionannulelist);
        adapter = new InterventionsAdapter(InterventionsAnnuleActivity.this, listView, R.layout.listview_interventionsannule_adapter, db.getInterventionAnnuler());
    ...
    private void setupCustomDialog() {
        ...
        AlertDialogsHelper.getAddInterventionDialog(InterventionsAnnuleActivity.this, alertLayout, adapter);
    }
}
