...
public class InterventionsReporteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interventionsfait);
        initAll();
    }
    ...
    private void setupAdapter() {
        ...
        listView = findViewById(R.id.interventionreportelist);
        adapter = new InterventionsAdapter(InterventionsReporteActivity.this, listView, R.layout.listview_interventionsfait_adapter, db.getInterventionReporter());
    ...
    private void setupCustomDialog() {
        ...
        AlertDialogsHelper.getAddInterventionDialog(InterventionsReporteActivity.this, alertLayout, adapter);
    }
}
