...
public class WeekAdapter extends ArrayAdapter<Week> {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        String job = Objects.requireNonNull(getItem(position)).getJob();
        ...
        week = new Week(subject, job, room, time_from, time_to, color);
        ...
        if(convertView == null){
            ...
            holder.job = convertView.findViewById(R.id.teacher);
        ...
        holder.job.setText(week.getJob());
